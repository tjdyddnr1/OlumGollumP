...
public class OlumGollum {
    ...
    public OlumGollum(String user_mail, String password, String name, int first_id_cardnum, int phone_number, String address, int gender, String nickname) {
